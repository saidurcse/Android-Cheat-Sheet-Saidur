...
public class QueuesUsingStack {
    ...
    public static void main(String[] args) throws Exception {
        ...
        queueUsingStackWithFasterEnqueue.enqueue(3); //q1 = 3
        queueUsingStackWithFasterEnqueue.enqueue(6); //q1 = 6,3
        queueUsingStackWithFasterEnqueue.enqueue(10); //q1 = 10,6,3
        queueUsingStackWithFasterEnqueue.dequeue(); //q2 = 10,6    3 removed
        System.out.println(queueUsingStackWithFasterEnqueue.stack1 + "###" + queueUsingStackWithFasterEnqueue.stack2);

        queueUsingStackWithFasterEnqueue.enqueue(8); //q1 = 8
        queueUsingStackWithFasterEnqueue.enqueue(4); //q1 = 8,4
        queueUsingStackWithFasterEnqueue.dequeue(); //q2 = 10
        System.out.println(queueUsingStackWithFasterEnqueue.stack1 + "###" + queueUsingStackWithFasterEnqueue.stack2);
